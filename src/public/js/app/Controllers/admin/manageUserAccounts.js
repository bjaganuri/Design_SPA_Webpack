function manageUserAccounts($scope,restDataService,$state,userToView,ModalService,lastViewedUserActList,viewUserLastSearchParams){
	...
	$scope.executeUpdate = function(user){
		restDataService.postData("/manageAccountLock",user,function(response){
