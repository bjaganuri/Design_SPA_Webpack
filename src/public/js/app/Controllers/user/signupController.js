function signupController($scope,restDataService,$state,fileUpload,$timeout){
	$scope.newUser = {};
	...
	$scope.signUp = function($event){
		...
		if($scope.signUpForm.$valid){
			restDataService.postData("/signUp",signUpData,function(response){
	...
	$scope.importUsersList = function(importedFile , fileType){
		...
		var uploadUrl = "/importUsers/"+fileType;
		var fd = new FormData();
		fd.append('file', file);
