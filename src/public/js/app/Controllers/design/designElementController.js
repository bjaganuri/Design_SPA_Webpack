function designElementController($scope,restDataService){
	$scope.htmlElements = [];
	$scope.cssProps = [];
	...
	$scope.getHTMLElemsList = function () {
		restDataService.getData("/htmlElements",'',function(response){
	...
	$scope.getCSSPropsList = function () {
		restDataService.getData("/cssprops",'',function(response){
